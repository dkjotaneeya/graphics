...
#include "third_party/py/tensorflow_graphics/rendering/opengl/thread_safe_resource_pool.h"
...
TEST(ThreadSafeResourcePoolTest, TestMultiThread) {
  ...
  for (int i = 0; i < kNumThreads; ++i) {
    ...
    EXPECT_EQ(
        0, pthread_create(&threads[i], NULL, StartMemberRoutineWrapper, wrappers[i]));
  }
